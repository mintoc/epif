...
\hlstd{low.med.high.bulk}
\end{alltt}
\begin{verbatim}
##    10%    50%    90% 
## 26.132 60.500 93.280
\end{verbatim}
\begin{alltt}
\hlcom{## set high to 120kg}
\hlstd{low.med.high.bulk[}\hlnum{3}\hlstd{]} \hlkwb{<-} \hlnum{120}
...
\hlstd{mnom.pred.df}\hlopt{$}\hlstd{Bulk.Weight} \hlkwb{<-}
  \hlkwd{ifelse}\hlstd{(mnom.pred.df}\hlopt{$}\hlstd{Total.Weight} \hlopt{==} \hlstd{low.med.high.bulk[}\hlnum{1}\hlstd{],} \hlstr{"Low (26kg)"}\hlstd{,}
         \hlkwd{ifelse}\hlstd{(mnom.pred.df}\hlopt{$}\hlstd{Total.Weight} \hlopt{==} \hlstd{low.med.high.bulk[}\hlnum{2}\hlstd{],} \hlstr{"Medium (60.5kg)"}\hlstd{,} \hlstr{"High (120kg)"}\hlstd{)}
         \hlstd{)}
